                ...
                <?php if(!empty($alumno_lecturas)): ?>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <form method="post" action="<?php echo site_url('Web/admin/Alumno/resultTest');?>" class="question_hide" hidden="hidden">
                        ...
                        <a href="<?php echo site_url('Web/admin/Lectura/detail');?>/<?php echo $lectura->idLectura; ?>" class="btn bg-verde">
...
<script>
  $(function (){
    ...
    $.post(
        baseUrl+"Web/admin/Alumno/getDataChart2",
        data,
        (resp) => {
