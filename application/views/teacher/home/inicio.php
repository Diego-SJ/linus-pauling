...
<div class="modal fade" id="customPDFAlumnos" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <form method="post" action="<?php echo base_url().'Web/Reports/pdfdetails' ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check1" type="checkbox"> Nombre
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check2" type="checkbox"> Apellido paterno
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check3" type="checkbox"> Apellido materno
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check4" type="checkbox"> Usuario
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check5" type="checkbox"> Contraseña
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check6" type="checkbox"> Lecturas completadas
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check7" type="checkbox"> Grado
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check8" type="checkbox"> Grupo
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check9" type="checkbox"> Docente
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check10" type="checkbox"> Aciertos totales
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check11" type="checkbox"> Incorrectos totales
                      </label>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-6">
                      <label class="badge bg-gray btn btn-block mt-1 label-check">
                        <input id="check12" type="checkbox"> Promedio general
                      </label>
                    </div>
                  </div>
                </td>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-xs-6">
                      <select class="form-control">
                        <option value="">- elije un filtro -</option>
                        ...
                        <option id="opt6" hidden="hidden" value="total_lecturas">Lecturas completadas</option>
                        <option id="opt7" hidden="hidden" value="grado">Grado</option>
                        <option id="opt8" hidden="hidden" value="grupo">Grupo</option>
                        <option id="opt9" hidden="hidden" value="docente">Docente</option>
                        <option id="opt10" hidden="hidden" value="aciertos">Aciertos</option>
                        <option id="opt11" hidden="hidden" value="incorrectos">Incorrectos</option>
                        <option id="opt12" hidden="hidden" value="promedio">Promedio</option>
                      </select>
                    </div>
                    <div class="col-md-6 col-xs-6">
                      <select class="form-control">
...
<script>
  $(function () {
    ...
    $('#check12').on('click', function(){
      if($(this).prop('checked')){
        $('#opt12').removeAttr('hidden');
      } else {
        $('#opt12').attr('hidden','hidden');
      }
    })
  })
</script>