...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('Web/Alumno/detail/')?><?php if(!empty($header_info)){echo $header_info->idAlumno;} ?>"><i class="fa fa-user"></i> Detalle alumno</a></li>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th style="width: 70%;" class="text-center">
                                                <span class="badge bg-azul txt-15">Pregunta</span>
                                            </th>
                                            <th style="width: 15%;" class="text-center">
                                                <span class="badge bg-azul txt-15">Respuesta correcta</span>
                                            </th>
                                            <th style="width: 15%;" class="text-center">
                                                <span class="badge bg-azul txt-15">Respuesta alumno</span>
                                            </th>
                                            <th style="width: 15%;" class="text-center">
                                                <span class="badge bg-azul txt-15">Estado</span>
                                            </th>
                                        </tr>
                                        <?php 
                                        $index = 1;
                                        ...
                                        <tr>
                                            <td>
                                                <div>
                                                    <span class="text-azuld txt-20"><b><?php echo ($index.") ".$answer->pregunta); ?></b></span><br>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th style="width: 45%;" class="text-center">
                                                <span class="badge bg-azul txt-15">Columa preguntas</span>
                                            </th>
                                            <th style="width: 45%;" class="text-center">
                                                <span class="badge bg-azul txt-15">Columna respuestas</span>
                                            </th>
                                        ...
                                        <tr>
                                            <td class="txt-15 text-azuld"><b><?php echo $answer->question_1; ?></b></td>
                                        ...
                                        <tr>
                                            <td class="txt-15 text-azuld"><b><?php echo $answer->question_2; ?></b></td>
                                        ...
                                        <tr>
                                            <td class="txt-15 text-azuld"><b><?php echo $answer->question_3; ?></b></td>
                                        ...
                                        <tr>
                                            <td class="txt-15 text-azuld"><b><?php echo $answer->question_4; ?></b></td>
                            ...
                            <div class="post">
                                <table class="table table-bordered table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <span class="txt-15 text-azuld"><b><?php echo $answer->question; ?></b></span>
                                            </td>
