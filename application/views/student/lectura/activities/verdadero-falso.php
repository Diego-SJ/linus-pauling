            ...
            <div class="box-body">
              ...
              <form id="from_test_vf" method="post" action="<?php echo base_url().'Movil/Actividades/verificar_vf'?>/<?php if(!empty($lectura)){echo $lectura->idLectura;} ?>" class="padding-square-no-top-bottom">
                ...
                <blockquote class=" bg-block-gray">
                  <h4 class="reactivo">
                    <!-- pregunta -->
                    <input class="question_hide" hidden="hidden" readonly name="question_<?php echo $index; ?>" value="<?php echo ($index.") ".$reactivo->pregunta); ?>">
                  ...
                  <!-- respuestas -->
                    ...
                    <div id="sdd" class=" no-padding-top">
                      <p>
                        <input type="radio" value="verdadero" name="resp_<?php echo $index; ?>" class="flat-red">
                        Verdadero
                      </p>
                      <p>
                        <input type="radio" value="falso" name="resp_<?php echo $index; ?>" class="flat-red">
                        Falso
                      </p>
                    </div>
                </blockquote>
